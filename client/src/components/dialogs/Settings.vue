  ...
  >
    ...
    >
      ...
      <div
        ...
        style="width:200px; gap:12px; max-height:calc(70vh - 24px); overflow:auto;"
      >
        <div
          v-for="item in items"
          :key="item.key"
      ...
      <!-- Main dialog card -->
      <v-card style="min-width:560px; max-width:720px; height:calc(70vh - 24px); display:flex; flex-direction:column;">
        <v-card-title>
          <span class="headline">Settings (Esc)</span>
        </v-card-title>
