...
const api_old = {
  ...
  get: (url, input) => api_old.call('GET', url, input),
  post: (url, input) => api_old.call('POST', url, input),
  patch: (url, input) => api_old.call('PATCH', url, input),
  delete: (url, input) => api_old.call('DELETE', url, input),
};
