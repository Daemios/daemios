...
export const useUserStore = defineStore('user', {
  state: () => ({
    ...
    character: {
      ...
      race: null,
      archetype: {
        range: { range_id: 1, label: 'Melee', description: 'Disables some ranges, but adds more HP and Power.' },
        role: { role_id: 2, label: 'Damage', description: 'Things need bonk? You bonk.' },
      },
      cores: {
        1: { id: 1, label: 'My Best Spell', prefix: 'Cracked', tier: 1, sockets: 1, range: 2, shape: 1, type: 1, power: 0, cost: 0, cooldown: 0 },
      },
      equipped: {},
    },
    inventory: [],
